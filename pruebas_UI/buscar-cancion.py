...
text_field_busqueda_cancion_nombre = wait.until(EC.presence_of_element_located((By.ID,"name")))
text_field_busqueda_cancion_nombre.send_keys("dorothea")
text_field_busqueda_cancion_artist = wait.until(EC.presence_of_element_located((By.ID,"artist")))
text_field_busqueda_cancion_artist.send_keys("Taylor Swift")
text_field_busqueda_cancion_genre = wait.until(EC.presence_of_element_located((By.ID,"genre")))
text_field_busqueda_cancion_genre.send_keys("Pop")
time.sleep(5)
